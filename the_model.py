...
def build_modelE(data, labels):
      ...
      model = keras.Sequential([
                  ...
                  keras.layers.Bidirectional(layers.LSTM(500, dropout=.25, return_sequences=True), merge_mode='concat'),
                  keras.layers.Bidirectional(layers.LSTM(500, dropout=.25),merge_mode='concat'),
